...
│   └── mcpvectordb/
│       ├── __init__.py
│       ├── server.py          # MCP entry point; registers tools; selects transport
│       ├── transport.py       # stdio vs SSE/HTTP transport selection
...
│   ├── test_embedder.py
│   ├── test_store.py
│   └── test_server.py         # MCP tool contract tests (both transports)
├── docs/
